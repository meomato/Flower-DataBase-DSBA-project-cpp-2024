...
20. **void sortAlphabetically()**
    - Слот для сортировки по алфавиту.
   

 - **На вход:** ничего не принимает.
    - **На выход:** ничего не возвращает.

21. **void sortReverseAlphabetically()**
    - Слот для сортировки против алфавита.
    - **На вход:** ничего не принимает.
    - **На выход:** ничего не возвращает.

22. **void resetFilters()**
    - Слот для очистки фильтров для сортировки цветов.
    - **На вход:** ничего не принимает.
    - **На выход:** ничего не возвращает.

23. **void showInfo()**
    - Слот для показа информации о приложении.
    - **На вход:** ничего не принимает.
    - **На выход:** ничего не возвращает.
...
#### Файл: `informationwind.h`

1. **InformationWind(QWidget *parent = nullptr)**
   - Конструктор класса InformationWind.
   - **На вход:** указатель на родительский виджет.
   - **На выход:** ничего не возвращает.

2. **~InformationWind()**
   - Деструктор класса InformationWind.
   - **На вход:** ничего не принимает.
   - **На выход:** ничего не возвращает.

3. **void clicked_on_toolButton_5()**
   - Слот для обработки нажатия на кнопку закрытия окна информации.
   - **На вход:** ничего не принимает.
   - **На выход:** ничего не возвращает.
